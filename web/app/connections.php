	...
	<div class="container-fluid" style="max-width:992px; margin: 0 auto;">
		<div class="list-group">
			...
			foreach($conList as $con){
				echo('<a href="webapp.php?code='.$con['code'].'" class="list-group-item">');
				echo('<div style="overflow:hidden">');
				echo('<img src="'.$con['thumbnail'].'" class="img-responsive img-thumbnail" style="float:left;margin-right:15px">');
				echo('<span>Description: '.$con['description'].'</span> <br>');
				echo('<span class="small">Code: '.$con['code'].'</span><br>');
				echo('<span class="small">Category: '.$con['type'].'</span><br>');
